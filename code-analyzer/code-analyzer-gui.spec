...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "src.parser.php_parser",
        "src.parser.java_parser",
        "src.parser.generic_parser",
        "src.analyzer",
        "src.analyzer.llm_client",
        "src.analyzer.incremental_cache",
        "src.analyzer.rule_engine",
        "src.analyzer.project_detector",
        "src.analyzer.api_detector",
        "src.analyzer.db_model_analyzer",
        "src.analyzer.quality_analyzer",
        "src.analyzer.git_analyzer",
        "src.analyzer.security_scanner",
        "src.graph",
